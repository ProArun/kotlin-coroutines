package com.arun.kotlincoroutines.demonstrations.uithread
...
fun UiThreadDemoFragment() {
    ...
    Column(modifier = Modifier.padding(10.dp)) {
        Button(
            ...
            Text(text = "Start BenchMark (${if (isButtonEnabled.value) "enabled" else "disabled"})")
        }
